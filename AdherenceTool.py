...
from tool_version import getToolVersion
import shutil
...
class MainApplication(tk.Tk):
    def __init__(self):
        ...
        version_string = getToolVersion() #we should get this from the hash 
        self.title("Adherence Report Generator - (" + version_string + ")")
...
class MainFrame(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.logParser_button.place(relx = 0.15, rely = 0.60)
